 ...
 */
public class S3Upoloads extends HttpServlet
{
    // This assumes your secret key is available in an environment variable.
    // It is needed to sign policy documents.
    final static String AWS_SECRET_KEY = System.getenv("nhA0bt6rI65nQByvUuiIZENtJNK/nnnakeRlZGLh");

    // You will need to use your own public key here.
    final static String AWS_PUBLIC_KEY = "AKIAJPXSQETK5BB6ANQQ";
    ...
    public void doDelete(HttpServletRequest req, HttpServletResponse resp) throws IOException
    {
        ...
        String bucket = req.getParameter("buketforimage");
