...
// System.out.println(“toDecodeBase64Key = “+toDecodeBase64Key);
		...
		String testAngular = "VbBUzDChLFL5j1nQ+rWYbg==";
...
// AES Decryption based on above secretKey
		...
		String decrStrAngular = Crypt.decrypt(testAngular, encodedBase64Key);
		System.out.println("Decryption of Angular str = " + decrStrAngular);
	}
}